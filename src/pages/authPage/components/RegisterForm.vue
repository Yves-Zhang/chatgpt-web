<template>
  <n-form ref="formRef" :model="model" :rules="rules">
    ...
    <n-form-item path="password" label="密码">
      <Vinput placeholder="请设置密码" 
        v-model:value="model.password" type="password" @input="handlePasswordInput" @keydown.enter.prevent />
    </n-form-item>
    <n-form-item ref="rPasswordFormItemRef" first path="reenteredPassword" label="重复密码">
      <Vinput placeholder="请再次确认密码" 
        v-model:value="model.reenteredPassword" :disabled="!model.password" type="password" @keydown.enter.prevent />
    </n-form-item>
    <n-form-item ref="rCaptcha" first path="captcha" label="手机验证码">
      ...
      <Vinput placeholder="请输入手机验证码" 
        v-model:value="model.reenteredPassword" @keydown.enter.prevent />
    </n-form-item>
    <n-row :gutter="[0, 24]">
      <n-col :span="24">
